...
const tooltipVariants = cva(
  'animate-in fade-in-0 zoom-in-95 data-[closed]:animate-out data-[closed]:fade-out-0 data-[closed]:zoom-out-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-55 w-fit origin-(--radix-tooltip-content-transform-origin) rounded-md px-3 py-1.5 text-xs text-balance',
  {
    variants: {
      variant: {
        default:
          'dark:border-border bg-zinc-950 text-white shadow-md shadow-black/5 dark:border dark:bg-zinc-300 dark:text-black',
        light:
          'border-border bg-background text-foreground border shadow-md shadow-black/5',
      },
    },
    defaultVariants: {
      variant: 'default',
